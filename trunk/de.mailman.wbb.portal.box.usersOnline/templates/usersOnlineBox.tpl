    {if $this->user->getPermission('user.board.canViewUsersOnlineBox')}
		<div class="border" id="box{$boxID}">
		    <div class="containerHead">
                ...
                {/if}
                <div class="containerContent"><a href="index.php?page=UsersOnline{@SID_ARG_2ND}">{lang}wbb.portal.box.usersOnlineBox.title{/lang}</a><a name="usersOnlineBoxTgt"></a></div>
            </div>
            <div id="usersOnlineBox"{if $usersOnlineBoxHeight > 0} style="max-height:{$usersOnlineBoxHeight}px; overflow-y:auto; overflow-x:hidden;"{/if}>
                <div class="containerContent" style="padding-right:5px; padding-bottom:5px;">
                	...
                	{if $users|count > 0}
                	    <div class="smallFont">
                			{if $usersOnlineBoxShowLegend && $usersOnlineMarkings|count > 0}
                			...
                			{/if}
                    		{lang}wcf.usersOnline.members{/lang}
          				</div>
                    ...
                    {if $usersOnlineBoxShowLegendBottom && $usersOnlineMarkings|count > 0}
                	    <div class="smallFont">

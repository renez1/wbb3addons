 ...
 * @author	MailMan
*/
class UserWantedPosterListMembersPage extends MultipleLinkPage {
	public $templateName = 'userWantedPosterListMembers';
	public $uwp;
	public $uwpData;
	...
	public function show() {
        ...
        if(WCF::getUser()->getPermission('user.membersList.canView')) HeaderMenu::setActiveMenuItem('wcf.header.menu.memberslist');

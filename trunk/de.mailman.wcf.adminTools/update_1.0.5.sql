ALTER TABLE `wcf1_admin_tool_setting` DROP INDEX `atse_name`;
ALTER TABLE `wcf1_admin_tool_setting` ADD PRIMARY KEY (`atse_name`);
...
INSERT IGNORE INTO `wcf1_admin_tool_setting` (`atse_name`, `atse_value`) VALUES ('cronLogUseAdminEmail', '0');

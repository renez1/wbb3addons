{* $Id$ *}
	...
	<div class="mainHeadline">
		<a href="index.php?page=UserWantedPosterList{@SID_ARG_2ND}" title="{lang}wcf.user.wantedPoster.list.title{/lang}"><img src="{@RELATIVE_WCF_DIR}icon/userWantedPosterListL.png" alt="" /></a>
		<div class="headlineContainer">
			<h2>{lang}wcf.user.usercp.menu.link.profile.wantedPoster.edit{/lang}</h2>
		</div>
	</div>
    ...
    {if $user->userID != $this->getUser()->userID}
		<p class="warning">{lang}wcf.user.wantedPoster.list.warningModEdit{/lang}</p>
	{/if}

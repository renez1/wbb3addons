			...
			{foreach from=$spiders item=spider}
				...
				<tr class="{cycle values="container-1,container-2" advance=false}" id="spiderRow{@$spider->spiderID}">
					...
					<td class="columnIcon">
						<script type="text/javascript">
							//<![CDATA[
							spiderData[{@$spider->spiderID}] = new Object();
							spiderData[{@$spider->spiderID}]['isMarked'] = {@$spider->isMarked()};
							spiderData[{@$spider->spiderID}]['class'] = '{cycle values="container-1,container-2"}';
							//]]>
						</script>												

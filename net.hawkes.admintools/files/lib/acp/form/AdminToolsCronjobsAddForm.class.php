...
class AdminToolsCronjobsAddForm extends CronjobsAddForm {		
	...
	public function save() {		
		...
		$sql = "INSERT INTO wcf".WCF_N."_admin_tools_cronjob_payload
					(cronjobID, packageID, functions)
					VALUES (".$cronjobID.", ".$this->packageID.", '".implode($this->activeFunctions)."')";
		WCF::getDB()->sendQuery($sql);
		$payloadID = WCF::getDB()->getInsertID();		
		$path = FileUtil::getRealPath(WCF_DIR.$row['packageDir']);
		$fileName = $path.'lib/system/cronjob/AdminToolsCronjob'.$cronjobID.'.class.php';
		$this->writeCronjob($cronjobID, $payloadID, $fileName);
	 ...
	 * @param Integer $payloadID
	 * @param String  $filename
	 */
	protected function writeCronjob($cronjobID, $payloadID, $filename) {
